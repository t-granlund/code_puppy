...
class TestActivateSkill:
    @pytest.mark.asyncio
    @patch("code_puppy.plugins.agent_skills.config.get_skills_enabled", return_value=False)
    ...
    @pytest.mark.asyncio
    @patch("code_puppy.plugins.agent_skills.config.get_skills_enabled", return_value=True)
    @patch("code_puppy.plugins.agent_skills.config.get_skill_directories", return_value=["/tmp"])
    @patch("code_puppy.plugins.agent_skills.discovery.discover_skills", side_effect=Exception("boom"))
    ...
    @patch("code_puppy.plugins.agent_skills.metadata.get_skill_resources", return_value=[])
    @patch("code_puppy.plugins.agent_skills.metadata.load_full_skill_content", return_value=None)
    @patch("code_puppy.plugins.agent_skills.discovery.discover_skills")
    @patch("code_puppy.plugins.agent_skills.config.get_skill_directories", return_value=["/tmp"])
    @patch("code_puppy.plugins.agent_skills.config.get_skills_enabled", return_value=True)
    async def test_load_content_fails(self, mock_en, mock_dirs, mock_disc, mock_load, mock_res, mock_bus):
        skill = MagicMock()
        skill.name = "test"
    ...
    @pytest.mark.asyncio
    @patch("code_puppy.tools.skills_tools.get_message_bus")
    @patch("code_puppy.plugins.agent_skills.metadata.get_skill_resources", return_value=["/tmp/r.txt"])
    @patch("code_puppy.plugins.agent_skills.metadata.load_full_skill_content", return_value="# Skill content")
    @patch("code_puppy.plugins.agent_skills.discovery.discover_skills")
    @patch("code_puppy.plugins.agent_skills.config.get_skill_directories", return_value=["/tmp"])
    @patch("code_puppy.plugins.agent_skills.config.get_skills_enabled", return_value=True)
    async def test_success(self, mock_en, mock_dirs, mock_disc, mock_load, mock_res, mock_bus):
        skill = MagicMock()
        skill.name = "test"
        skill.has_skill_md = True
        skill.path = "/tmp/test"
...
class TestListOrSearchSkills:
    ...
    @pytest.mark.asyncio
    @patch("code_puppy.plugins.agent_skills.config.get_skills_enabled", return_value=True)
    @patch("code_puppy.plugins.agent_skills.config.get_disabled_skills", return_value=set())
    @patch("code_puppy.plugins.agent_skills.config.get_skill_directories", return_value=["/tmp"])
    @patch("code_puppy.plugins.agent_skills.discovery.discover_skills", side_effect=Exception("boom"))
    ...
    @patch("code_puppy.plugins.agent_skills.discovery.discover_skills")
    @patch("code_puppy.plugins.agent_skills.config.get_skill_directories", return_value=["/tmp"])
    @patch("code_puppy.plugins.agent_skills.config.get_disabled_skills", return_value={"disabled-skill"})
    @patch("code_puppy.plugins.agent_skills.config.get_skills_enabled", return_value=True)
    async def test_list_with_filter(self, mock_en, mock_dis, mock_dirs, mock_disc, mock_meta, mock_bus):
        skill1 = MagicMock()
    ...
    @patch("code_puppy.plugins.agent_skills.config.get_disabled_skills", return_value=set())
    @patch("code_puppy.plugins.agent_skills.config.get_skills_enabled", return_value=True)
    async def test_search_by_name(self, mock_en, mock_dis, mock_dirs, mock_disc, mock_meta, mock_bus):
        skill = MagicMock()
    ...
    @patch("code_puppy.plugins.agent_skills.config.get_disabled_skills", return_value=set())
    @patch("code_puppy.plugins.agent_skills.config.get_skills_enabled", return_value=True)
    async def test_search_by_description(self, mock_en, mock_dis, mock_dirs, mock_disc, mock_meta, mock_bus):
        skill = MagicMock()
        skill.name = "my-skill"
        skill.has_skill_md = True
        skill.path = "/tmp/s"
    ...
    @patch("code_puppy.plugins.agent_skills.config.get_disabled_skills", return_value=set())
    @patch("code_puppy.plugins.agent_skills.config.get_skills_enabled", return_value=True)
    async def test_search_by_tag(self, mock_en, mock_dis, mock_dirs, mock_disc, mock_meta, mock_bus):
        skill = MagicMock()
        skill.name = "my-skill"
        skill.has_skill_md = True
        skill.path = "/tmp/s"
    ...
    @patch("code_puppy.plugins.agent_skills.config.get_disabled_skills", return_value=set())
    @patch("code_puppy.plugins.agent_skills.config.get_skills_enabled", return_value=True)
    async def test_search_no_match(self, mock_en, mock_dis, mock_dirs, mock_disc, mock_meta, mock_bus):
        skill = MagicMock()
        skill.name = "my-skill"
        skill.has_skill_md = True
        skill.path = "/tmp/s"
    ...
    @pytest.mark.asyncio
    @patch("code_puppy.tools.skills_tools.get_message_bus")
    @patch("code_puppy.plugins.agent_skills.metadata.parse_skill_metadata", return_value=None)
    @patch("code_puppy.plugins.agent_skills.discovery.discover_skills")
    @patch("code_puppy.plugins.agent_skills.config.get_skill_directories", return_value=["/tmp"])
    @patch("code_puppy.plugins.agent_skills.config.get_disabled_skills", return_value=set())
    @patch("code_puppy.plugins.agent_skills.config.get_skills_enabled", return_value=True)
    async def test_no_metadata(self, mock_en, mock_dis, mock_dirs, mock_disc, mock_meta, mock_bus):
        skill = MagicMock()
