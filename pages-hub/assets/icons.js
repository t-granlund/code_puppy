...
(function () {
  ...
  var P = {
    // nav / structural
    hub: '<circle cx="12" cy="12" r="10"/><path d="m16.24 7.76-2.12 6.36-6.36 2.12 2.12-6.36 6.36-2.12z"/>',
    ...
    swatch: '<path d="m12 3-1.9 5.8a2 2 0 0 1-1.28 1.28L3 12l5.82 1.9a2 2 0 0 1 1.28 1.28L12 21l1.9-5.82a2 2 0 0 1 1.28-1.28L21 12l-5.82-1.9a2 2 0 0 1-1.28-1.28Z"/>',
    // architecture nodes
    ...
    flask: '<path d="M10 2v7.5L4.5 20a1.4 1.4 0 0 0 1.3 2h12.4a1.4 1.4 0 0 0 1.3-2L14 9.5V2"/><path d="M8.5 2h7"/><path d="M7 16h10"/>',
    package: '<path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/>',
    upload: '<path d="M4 14.9A7 7 0 1 1 15.7 8h1.8a4.5 4.5 0 0 1 2.4 8.3"/><path d="M12 12v9"/><path d="m16 16-4-4-4 4"/>',
    wrench: '<path d="M14.7 6.3a4.5 4.5 0 0 0 6 6L21 12a9 9 0 1 1-9-9l.3.01z"/><path d="m21 3-6.5 6.5"/><path d="m9 15 6-6"/>',
    fork: '<circle cx="6" cy="6" r="3"/><circle cx="18" cy="6" r="3"/><circle cx="12" cy="18" r="3"/><path d="M6 9v2a3 3 0 0 0 3 3h6a3 3 0 0 0 3-3V9"/>',
    ...
    // section icons
    bot: '<rect x="4" y="8" width="16" height="12" rx="2"/><path d="M12 8V4H8"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M15 13v2"/><path d="M9 13v2"/>',
