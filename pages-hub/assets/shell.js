...
(function () {
  ...
  var logo = '<img src="' + assets + 'code_puppy_logo_white.png" alt="Code Puppy logo" width="30" style="height:auto" />';
  ...
  var topbar =
    ...
    '  <a class="brand" href="' + base + 'index.html"><img src="' + assets + 'code_puppy_logo_white.png" alt="Code Puppy logo" width="26" style="height:auto" /><span>Code Puppy</span></a>' +
