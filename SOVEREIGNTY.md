...
|---|---|---|---|
| **Working source clone** | `~/code_puppy/` | Live development + install source |  main @ v0.0.751 |
...
| **Installed tool** | `~/.local/share/uv/tools/code-puppy/` | Currently-running CLI (uv tool install) |  v0.0.751 |
