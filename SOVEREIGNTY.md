...
|---|---|---|---|
| **Working source clone** | `~/code_puppy/` | Live development + install source |  main @ v0.0.750 |
...
| **Installed tool** | `~/.local/share/uv/tools/code-puppy/` | Currently-running CLI (uv tool install) |  v0.0.750 |
| **Offline wheel** | `~/code_puppy/dist/code_puppy-0.0.709-py3-none-any.whl` | Zero-network reinstall artifact |  built Aug 13 (stale; rebuild with `uv build` if needed) |
